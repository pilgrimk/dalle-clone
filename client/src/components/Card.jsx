...
const Card = ({ _id, name, prompt, photo }) => {
  return (
    <div className='rounded-xl group relative shadow-cord 
    hover:shadow-cardhover card'>
      <img
        className='w-full h-auto object-cover rouned-xl'
        src={photo}
        alt={prompt}
      />
      <div className='group-hover:flex flex-col max-h-[94.5%] 
      hidden absolute bottom-0 left-0 right-0 bg-[hsl(228,32%,9%)] 
      m-2 p-4 rouned-md'>
